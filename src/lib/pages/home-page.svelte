...
<section
        class="flex flex-col items-start justify-center relative h-[40dvh] md:h-[40dvh] after:absolute after:inset-0 after:block after:bg-primary after:opacity-50 after:z-[-1] text-primary-foreground">
...
<section class="mx-auto w-full md:max-w-[75vw] px-4 md:px-0 mb-12">
    <h2 class="heading-2 my-4 mb-8">{home.page.featuredTitle}</h2>
    <div class="mx-2 md:mx-4 lg:mx-8 flex items-stretch justify-center gap-4 lg:gap-8 flex-wrap md:flex-nowrap">
